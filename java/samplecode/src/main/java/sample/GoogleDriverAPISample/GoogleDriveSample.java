package sample.GoogleDriverAPISample;
    ...
    *//** Authorizes the installed application to access user's protected data. *//*
    private static Credential authorize() throws Exception {
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
                new InputStreamReader(GoogleDriveSample.class.getResourceAsStream("/client_secrets.json")));
        if (clientSecrets.getDetails().getClientId().startsWith("Enter")
                || clientSecrets.getDetails().getClientSecret().startsWith("Enter ")) {
            System.out.println(
                    "Enter ServiceProvider ID and Secret from https://code.google.com/apis/console/?api=drive "
    ...
    public static void main(String[] args) {
        Preconditions.checkArgument(
                ...
                "Please enter the upload file path and download directory in %s", GoogleDriveSample.class);
