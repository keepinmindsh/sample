<script>
    ...
    const logPaths = [
        {title:"91_NextCMS_Log",path:"D:/boot-workspace/WINGS-API-CMS/01_Common"},
        {title:"com", path:"D:/boot-workspace/WINGS-API-CMS/08_WingsCMS_Distributed"},
        {title:"oper01", path:"D:/boot-workspace/WINGS-API-CMS/11_WingsCMS"},
        {title:"oper02", path: "D:/boot-workspace/WINGS-API-CMS/21_OTA"},
        {title:"pms", path: "D:/boot-workspace/WINGS-API-CMS/99_Cloud"},
        {title:"spring-boot", path: "D:/boot-workspace/WINGS-API-CMS"}
    ];

    const clickLogPath = (event, path) => {
                    ...
                    <div class="row p-1">
                        <ul class="list-group">
                            {#each logPaths as path}
                                <li class="list-group-item" on:click={(event) => { clickLogPath(event, path.path)  }}>{path.title}</li>
                            {/each}
                        </ul>
                    </div>
                </div>
