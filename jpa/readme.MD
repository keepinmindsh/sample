...
```shell
Hibernate: 
    /* insert bong.lines.jpashoping.step5.Member
        */ insert 
        into
            Member
            (USERNAME, MEMBER_ID) 
        values
            (?, ?)
Hibernate: 
    /* insert bong.lines.jpashoping.step5.Team
        */ insert 
        into
            Team
            (name, TEAM_ID) 
         values
            (?, ?)
Hibernate: 
    /* create one-to-many row bong.lines.jpashoping.step5.Team.members */ update
        Member 
    set
        TEAM_ID=? 
    where
